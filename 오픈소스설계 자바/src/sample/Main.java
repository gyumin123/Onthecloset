...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        mainPanel.add(new WelcomePanel(this).createPanel(), "welcome");
        mainPanel.add(new RegisterPanel(this).createPanel(), "register");
        mainPanel.add(new CheckVisitPanel(this).createPanel(), "checkVisit");
...
class WelcomePanel {
    ...
    public JPanel createPanel() {
        ...
        registerButton.addActionListener(e -> main.getCardLayout().show(main.getMainPanel(), "register"));
        checkVisitButton.addActionListener(e -> main.getCardLayout().show(main.getMainPanel(), "checkVisit"));
...
class RegisterPanel {
    ...
    public JPanel createPanel() {
        ...
        submitButton.addActionListener(e -> {
            ...
            // 가입 후 첫 화면으로 돌아가기
            Timer timer = new Timer(2000, event -> main.getCardLayout().show(main.getMainPanel(), "welcome"));
...
class CheckVisitPanel {
    private Main main;

    public CheckVisitPanel(Main main) {
        this.main = main;
    }
    ...
    public JPanel createPanel() {
        ...
        searchButton.addActionListener(e -> {
            ...
            for (HashMap<String, String> user : main.getUsers()) {
